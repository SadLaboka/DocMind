...
from src.schemas.prompts import PromptRequest, PromptResponse
...
@router.post(
    "/prompts", summary="Create new prompt", status_code=status.HTTP_201_CREATED, response_model=PromptResponse
)
